            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Add Education</h5>
                  </div>

                  <br>

                  <form action="{{route('saveedu')}}" method="post" class="row g-3 needs-validation">
                    @csrf
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Add Education</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Want to go back? <a href="dashboard">Click here</a></p>
                    </div>
                  </form>
