...
<body>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="{{route('login-admin')}}" method="post" class="row g-3 needs-validation">
                    @csrf
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Do not have an account?<a href="signup"> Click here</a></p>
                    </div>
                  </form>
  ...
  <script src="{{ asset('import/assets/js/mainlogres.js') }}"></script>
