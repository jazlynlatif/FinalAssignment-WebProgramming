            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Edit Projects</h5>
                  </div>

                  <br>

                  <form action="{{route('updateproject')}}" method="post" class="row g-3 needs-validation">
                    @csrf
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="category" placeholder="Category" value="{{$data->category}}" class="form-control" required>
                        <div class="invalid-feedback">Please enter the category</div>
                    </div>

                    <div class="col-12">
                      <label class="form-label">Status</label>
                      <input type="text" name="status" placeholder="Status" value="{{$data->status}}" class="form-control" required>
                      <div class="invalid-feedback">Please enter the status</div>
                    </div>

                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Edit Project</button>
                    </div>
                    <div class="col-12">
